...
p1 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident")  
p2 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident", minCounts = 10, minSamples = 15)  
p3 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident", minCounts = 50, minSamples = 15)  
p4 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident", minCounts = 100, minSamples = 15)  
p5 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident", minCounts = 10, minSamples = 30) 
p6 = plotDensity(dds.list = dds.deseq.list, cluster = 2, jby = "orig.ident", minCounts = 20, minSamples = 15)

library(patchwork)   
p1$densityPlot / p2$densityPlot / p3$densityPlot / p4$densityPlot / p5$densityPlot / p6$densityPlot
